...
void power_usage_lut(t_power_usage* power_usage, int LUT_size, float transistor_size, std::vector<char> SRAM_values, std::vector<float> input_densities, std::vector<float> input_probabilities, float period);
